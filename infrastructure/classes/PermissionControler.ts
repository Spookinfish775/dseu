...
export class PermissionControler {
    static canUpdate(permission: number): boolean {
        return permission === Permission.Update || permission === Permission.FullAccess
    }
    static canCreate(permission: number): boolean {
        return permission === Permission.Create || permission === Permission.Update || permission === Permission.FullAccess
    }
    ...
    static administrationAccess(filteredClaims: IClaim): boolean {
        return filteredClaims.hasOwnProperty("User") ||
    ...
    static agencyAccess(filteredClaims: IClaim): boolean {
        return filteredClaims.hasOwnProperty("Statement") ||
