<template>
  <div class="card-wrapper">
    ...
    <RealEstateSelectBox
      :value="actualRealEstateId"
      @valueChanged="changeActualRealEstate"
    />
    <p class="oldData">
      {{ $t("labels.incomingInformation") }} : <b>{{ data.address }}</b>
    </p>
    <DxForm
      ref="form"
      label-location="top"
...
export default Vue.extend({
  ...
  methods: {
    ...
    changeActualRealEstate(actualRealEstateId) {
      this.actualRealEstateId = actualRealEstateId;
      this.getRealEstate(actualRealEstateId);
    },
    async getRealEstate(id) {
      ...
      this.realEstate = new RealEstate(data);
    ...
    saveRealEstate() {
      ...
      console.log(this.dataIsChanged);
      console.log(this.actualRealEstateId);
