<template>
	<div>
		<BaseToolbar :canSave="canCreate" @save="savePrepayment" />
		<DxForm ref="form" label-location="top" :form-data.sync="prepayment">
...
export default Vue.extend({
	...
	created() {
		if (this.$route.query.statementId) {
			this.prepayment.statementId = +this.$route.query.statementId;
		}
	}
});
</script>
