    ...
    >
      ...
      <template #representativeDocumentsDataGrid>
        <RepresentativeDocumentsDataGrid
          :data="applicant.representativeDocuments"
...
export default Vue.extend({
  ...
  methods: {
    ...
    saveApplicant() {
      ...
      if (result.isValid) {
        this.$awn.asyncBlock(
          this.$axios.put(`${this.$dataApi.applicant}/${this.data.id}`, {
            ...this.applicant,
            id: this.data.id
          }),
          e => {
    ...
    deleteApplicant() {
      ...
      result.then(dialogResult => {
        if (dialogResult) {
          this.$awn.asyncBlock(
            this.$axios.delete(
              `${this.$dataApi.applicant}/${this.applicant.id}`
            ),
            e => {
              this.$awn.success();
