<template>
	...
	>
		...
		<DxExport
			...
			:file-name="$t('navigation.administration.specialApplicantTypeTitle')"
		/>
		<DxStateStoring
			:enabled="true"
			type="localStorage"
			storage-key="specialApplicantTypeName"
		/>
		<DxEditing
		...
		return {
			dataSource: new DataSource({
				store: this.$dxStore({
					...
					insertUrl: this.$dataApi.specialApplicantType,
					removeUrl: this.$dataApi.specialApplicantType,
					updateUrl: this.$dataApi.specialApplicantType
				})
			}),
