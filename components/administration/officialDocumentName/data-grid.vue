<template>
  ...
  >
    ...
    <DxExport
      ...
      :file-name="$t('navigation.administration.officialDocumentNameTitle')"
    />
    <DxStateStoring
      :enabled="true"
      type="localStorage"
      storage-key="officialDocumentName"
    />
    <DxEditing
    ...
    return {
      dataSource: new DataSource({
        store: this.$dxStore({
          ...
          insertUrl: this.$dataApi.officialDocumentName,
          removeUrl: this.$dataApi.officialDocumentName,
          updateUrl: this.$dataApi.officialDocumentName,
        }),
      }),
  ...
  computed: {
    canCreate() {
      let permission: number =
        this.$store.getters["user/claims"]["OfficialDocumentName"];
