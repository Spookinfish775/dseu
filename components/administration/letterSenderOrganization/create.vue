...
import { LetterSenderOrganization } from "~/infrastructure/classes/administration/LetterSenderOrganization";
...
export default Vue.extend({
	...
	data() {
		let formData: ILetterSenderOrganization = new LetterSenderOrganization();
		return {
			formData
		};
	},
	...
	methods: {
		...
		onSave() {
			...
			if (result.isValid) {
				this.$awn.asyncBlock(
					this.$axios.post(
						this.$dataApi.letterSenderOrganization,
						this.formData
					),
					e => {
						this.$awn.success();
