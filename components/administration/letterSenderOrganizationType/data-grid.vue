<template>
	...
	>
		...
		<DxExport
			...
			:file-name="
				$t('navigation.administration.letterSenderOrganizationTypeTitle')
			"
		/>
		<DxStateStoring
			:enabled="true"
			type="localStorage"
			storage-key="letterSenderOrganizationType"
		/>
		<DxEditing
		...
		return {
			dataSource: new DataSource({
				store: this.$dxStore({
					...
					insertUrl: this.$dataApi.letterSenderOrganizationType,
					removeUrl: this.$dataApi.letterSenderOrganizationType,
					updateUrl: this.$dataApi.letterSenderOrganizationType
				})
			}),
