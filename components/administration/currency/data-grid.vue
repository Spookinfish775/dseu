<template>
  ...
  >
    ...
    <DxExport
      ...
      :file-name="$t('navigation.administration.currencyTitle')"
    />
    <DxStateStoring
      :enabled="true"
      type="localStorage"
    ...
    return {
      dataSource: new DataSource({
        store: this.$dxStore({
          ...
          insertUrl: this.$dataApi.currency,
          removeUrl: this.$dataApi.currency,
          updateUrl: this.$dataApi.currency,
        }),
      }),
  ...
  computed: {
    canCreate() {
      let permission: number =
        this.$store.getters["user/claims"]["Currency"];
