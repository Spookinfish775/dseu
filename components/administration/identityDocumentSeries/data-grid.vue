  ...
  <div>
    ...
    >
      ...
      <DxExport
        ...
        :file-name="$t('navigation.administration.identityDocumentSeriesTitle')"
      />
      <DxStateStoring
        :enabled="true"
        type="localStorage"
    ...
    return {
      dataSource: new DataSource({
        store: this.$dxStore({
          ...
          insertUrl: this.$dataApi.IdentityDocumentSeries,
          removeUrl: this.$dataApi.IdentityDocumentSeries,
          updateUrl: this.$dataApi.IdentityDocumentSeries,
        }),
      }),
  ...
  computed: {
    canCreate() {
      let permission: number =
        this.$store.getters["user/claims"]["IdentityDocumentSeries"];
